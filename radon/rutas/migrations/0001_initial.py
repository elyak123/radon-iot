# Generated by Django 2.2.10 on 2020-05-14 18:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='DispositivoRuta',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('orden', models.IntegerField(verbose_name='Orden del dispositivo dentro de una ruta.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dispositivo', models.ManyToManyField(through='rutas.DispositivoRuta', to='iot.Dispositivo')),
